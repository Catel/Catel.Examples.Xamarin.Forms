...
namespace GitMeet.Models
{
    public class UserModel : ModelBase
    {
        ...
        public static readonly PropertyData IdProperty = RegisterProperty<UserModel, string>(model => model.Id);

        /// <summary>Register the UserName property so it is known in the class.</summary>
        public static readonly PropertyData UserNameProperty = RegisterProperty<UserModel, string>(model => model.UserName);

        /// <summary>Register the DisplayName property so it is known in the class.</summary>
        public static readonly PropertyData DisplayNameProperty = RegisterProperty<UserModel, string>(model => model.DisplayName);

        /// <summary>Register the Url property so it is known in the class.</summary>
        public static readonly PropertyData UrlProperty = RegisterProperty<UserModel, string>(model => model.Url);

        /// <summary>Register the AvatarUrlSmall property so it is known in the class.</summary>
        public static readonly PropertyData AvatarUrlSmallProperty = RegisterProperty<UserModel, string>(model => model.AvatarUrlSmall);

        /// <summary>Register the AvatarUrlMedium property so it is known in the class.</summary>
        public static readonly PropertyData AvatarUrlMediumProperty = RegisterProperty<UserModel, string>(model => model.AvatarUrlMedium);
